<template>
  <div class="max-w-7xl mx-auto px-4 py-12 min-h-screen">
    <div class="text-center mb-12 animate-fade-in-down">
      ...
      <h1
        class="text-4xl md:text-6xl font-black font-serif text-gray-900 border-b-1 border-[#d4a017] inline-block pb-2"
      >
        Resensi
      </h1>
    </div>
...
const fetchPosts = async () => {
  loading.value = true;
  try {
    const response = await axios.get("http://127.0.0.1:8000/api/posts?category=Resensi");
