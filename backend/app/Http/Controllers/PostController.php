...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('thumbnail')) {
            ...
            try {
                ...
                return back()->withErrors(['image_url' => 'Gagal download gambar']);
            }
        }
    ...
    public function update(Request $request, $id) {
        $post = Post::findOrFail($id);
        $post->update($request->all()); // Sesuaikan logic update gambar jika perlu
        return redirect()->route('posts.index')->with('success', 'Update Berhasil');
    }
